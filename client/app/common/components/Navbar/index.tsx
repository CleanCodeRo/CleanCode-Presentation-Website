        ...
        >
          <li className={style.dropItem}>
            <Link
              ...
              onClick={() =>
                mobileMenuOpen && handleMouseEnter(SERVICES_JSON_PATH)
              }
            >
              {t("navbar.services")}
            </Link>
          ...
          <li className={style.dropItem}>
            <Link
              href="/about-us"
              className={`${style.navLink} ${
                pathname === "/about-us" ? style.active : ""
              }`}
              onMouseLeave={() => !mobileMenuOpen && handleMouseLeave}
            >
              {t("navbar.aboutUs")}
          ...
          {mobileMenuOpen && (
            <li className={`${style.dropItem} ${style.mobileContactItem}`}>
              <Link
                href="/contact-us"
                className={`${style.navLink} ${style.mobileContactLink} ${
                  pathname === "/contact-us" ? style.active : ""
                }`}
              >
                CONTACT US
              </Link>
        ...
        <li className={`${style.navItem} ${style.desktopContactItem}`}>
          <Link
            ...
            className={`${style.buttonLink} ${
              pathname === "/contact-us" ? style.activeBtn : ""
            }`}
          >
            {t("navbar.contact")}
          </Link>
