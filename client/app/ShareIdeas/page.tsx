  ...
  return (
    <>
      ...
      <div className={style.TitleAndDescription}>
        <div className={style.contactTitle}>Don’t wait - <span className={style.highlight}>share your ideas with us.</span></div>
        <div className={style.contactDescription}>Connect now to explore innovative software solutions and take the first step towards making your dream project a success!</div>
      </div>
